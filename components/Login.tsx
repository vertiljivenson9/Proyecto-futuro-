  ...
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center p-6 font-mono text-center">
      <div className="w-full max-w-sm glass p-12 rounded-[4rem] border border-white/10 shadow-2xl">
        <div className="w-20 h-20 bg-indigo-600 rounded-3xl mx-auto flex items-center justify-center text-4xl mb-10 shadow-2xl font-bold">V</div>
        <h2 className="text-[10px] text-white/30 uppercase font-black tracking-widest mb-6 italic">Core Access Protocol</h2>
