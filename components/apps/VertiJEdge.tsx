...
const VertiJEdge = () => {
  ...
  return <div className="flex flex-col h-full bg-[#0a0a0a]">
    ...
    <div className="flex-grow relative bg-black">
      {!url ? <div className="absolute inset-0 flex items-center justify-center"><img src={OCEAN_BG} className="absolute inset-0 w-full h-full object-cover opacity-50" /><div className="z-10 text-8xl font-black text-white">VJ</div></div> : <iframe src={url} className="w-full h-full" />}
    </div>
  </div>;
};
